...
public class LookupTextField<T extends HasDisplayName> extends TextField {
    ...
    public LookupTextField (LinkedList<T> suggestions) {
        ...
        textProperty().addListener((observable, oldValue, newValue) -> {
            ...
            if (newValue.isBlank() || (selItem != null && newValue.equals(selItem.getDisplayName()))) {
            ...
            if (focusedProperty().get()) {
                ...
                for (T suggestion : this.suggestions) {
                    // System.out.println(
                    //     "suggestion(" + suggestion.getDisplayName().toLowerCase() + 
                    //     ") newValue(" + newValue.toLowerCase() +
                    //     ") contains? " + suggestion.getDisplayName().toLowerCase().contains(newValue.toLowerCase())
                    // );
                    if (suggestion.getDisplayName().toLowerCase().contains(newValue.toLowerCase())) {
        ...
        suggestionsListView.setOnMouseClicked(event -> {
            ...
            if (selectedItem != null) {
                setText(selectedItem.getDisplayName());
